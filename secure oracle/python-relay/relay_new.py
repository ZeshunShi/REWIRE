...
class ConfigRinkeby:
    ...
    SGX_WALLET_ADDR = Web3.toChecksumAddress("0xA1525dfaCb0c23f4C5354887F01814f6e38d131D")

    # JSON RPC endpoint
    TC_CORE_RPC_URL = "localhost:8123"

    # https://goerli.etherscan.io/address/0xd956c907448224ba895C7b2Ed424DA90174D6e89
    TC_CONTRACT_ADDR = Web3.toChecksumAddress("0xd956c907448224ba895C7b2Ed424DA90174D6e89")
    ...
    TC_REQUEST_TOPIC = "0x89e602545dca75050129a20ca09d26a160c5073f6b7130e71ac595b36d892038"
    ...
    def __init__(self):
        ...
        if environ.get('WEB3_INFURA_PROJECT_ID') is None:
            ...
            self.w3 = Web3(Web3.WebsocketProvider("wwss://goerli.infura.io/ws/v3/{}".format(infura_credential)))
...
class TCRelay:
    ...
    def send_response_check(self, response):
        ...
        self.logger.info("Transaction receipt mined. See https://goerli.etherscan.io/tx/%s", tx_hash.hex())
